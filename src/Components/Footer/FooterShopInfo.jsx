const FooterShopInfo = () => {
  const shopInfo = [
    {
      hds: "online shopping made easy at myntra",
      para: "If you would like to experience the best of online shopping for men, women and kids in India, you are at the right place. Myntra is the ultimate destination for fashion and lifestyle, being host to a wide array of merchandise including clothing, footwear, accessories, jewellery, personal care products and more. It is time to redefine your style statement with our treasure-trove of trendy items. Our online store brings you the latest in designer products straight out of fashion houses. You can shop online at Myntra from the comfort of your home and get your favourites delivered right to your doorstep.",
      subHds: "BEST ONLINE SHOPPING SITE IN INDIA FOR FASHION",
      subPara:
      ...
      bullets: [
        {
          bulletHds: "Smart men’s clothing",
          bulletMark: "1.",
          bulletPara:
        ...
        {
          bulletHds: "Trendy women’s clothing",
          bulletMark: "2.",
          bulletPara:
        ...
        {
          bulletHds: "Fashionable footwear",
          bulletMark: "3.",
          bulletPara:
      ...
      bullets: [
        {
          ...
          bulletParaScnd: "●  Curated collections from celeb stylists.",
        },
        {
          bulletHds: "Elite",
          bulletMark: null,
        ...
        },
        {
          bulletHds: "Icon",
          bulletMark: null,
          bulletPara: "●  Chance to get on guest lists for special events.",
          bulletParaScnd: null,
        },
      ],
      leastPara: null,
...

    {
      ...
      bullets: [
        ...
        {
          bulletHds: "Quick Fashion Tip And Tricks",
          bulletMark: "2.",
          bulletPara:
        ...
        {
          bulletHds: "Updates on What Is Trending and New Product Launches",
          bulletMark: "3.",
          bulletPara:
        ...
        {
          bulletHds: "Explicit Step-By-Step Beauty Routines From Experts",
          bulletMark: "4.",
          bulletPara:
        ...
        {
          bulletHds: "Celebrity Confessions And A Look Into Their Lives",
          bulletMark: "5.",
          bulletPara:
  ...
  return (
    <div className="footer-shop-wrapper mt-7 pt-2">
      <div className="footer-shop-container text-[#696e79] text-sm">
            ...
            return (
              <div key={idx} className="pb-7">
                ...
                <div className="bullets-container">
                  {sInfo.bullets.map((extBullet, index) => {
                    console.log(extBullet);
                    return (
                      <div key={index} className={`${idx === 1 ? "" : "ps-7"}`}>
                        <div className="bullet-content mb-4 flex">
                          <span className="mr-1">{extBullet.bulletMark}</span>
                          <p className="bullet-mark-hds-para">
                            <span
                              className={`${idx === 0 ? "" : "inline-block"}  ${
                                idx !== 0 ? "mb-4" : ""
                              }`}
                            >
                              <strong className="text-[#535766]">
                                {extBullet.bulletHds}
                              </strong>
                            </span>
                            {idx !== 0 ? (
                            ...
                            >
                              <span>{extBullet.bulletPara}</span> <br />
                              {extBullet.bulletParaScnd !== null ? (
                                <span className="inline-block mt-3">
                                  {extBullet.bulletParaScnd}
                                </span>
                              ) : (
                                ""
                              )}
        ...
        <div className="footer-about mt-[-10px]">
          {lowerShopInfo.map((info, idxx) => (
            <div key={idxx} className="footer-about-content mb-6 pb-1">
              <div className="about-hds mb-1 font-bold text-[#535766]">
                {info.hds}
              </div>
              <div className="about-para">{info.para}</div>
            </div>
          ))}
        </div>
      </div>
